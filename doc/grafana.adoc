...
The example is from a 5 minutes DORA benchmark, composed of two segments: the first with a rate of 500 DORA/s first, and the second a rate of 1000 DORA/s.
