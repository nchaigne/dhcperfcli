...
// note: not using the *assert macro, otherwise NULL would be printed as "((void *)0)" in one of the "#_x"
...
#define ncc_rand_str(_out, _len, _randstr, _randstr_len) \
	ncc_rand_str_ctx(_out, NULL, _len, _randstr, _randstr_len)
